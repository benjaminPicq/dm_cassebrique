...
def draw():
    ...
    if balle_y <= 128 :
        # polygone de 6 cotes
        pyxel.rect(plateau_x, plateau_y, 11, 7, 5)
        pyxel.tri(plateau_x, plateau_y, plateau_x, plateau_y+10, plateau_x-11, plateau_y+10, 8)
        pyxel.tri(plateau_x+11, plateau_y, plateau_x+11, plateau_y+10, plateau_x+22, plateau_y+10, 11)
        pyxel.rect(plateau_x-11, plateau_y+10, 32, 3, 14)
