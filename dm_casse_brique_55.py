...
def draw():
    ...
    if balle_y <= 128 :
        ...
        pyxel.tri(plateau_x, plateau_y, plateau_x, plateau_y+10, plateau_x-11, plateau_y+10, 3)
        pyxel.tri(plateau_x+11, plateau_y, plateau_x+11, plateau_y+10, plateau_x+22, plateau_y+10, 3)
